...
class npc_chat():
  ...
  def to_chat(self, user_q):
    context = {"Ava Armitage": """**** STORY_SETTING ****
EVENT_NAME: 
Innovation Nexus: Bridging Academia, Venture, and Tech
EVENT_DESCRIPTION: 
An exclusive evening of networking and insightful discussion, bringing together leading venture capitalists, renowned college professors, and innovative software engineers. The event will feature a panel discussion on the future of technology and its impact on society, followed by a cocktail reception with ample opportunities for connection and collaboration.
EVENT_PURPOSE: 
To foster dialogue and potential partnerships between key players in the academic, financial, and technological spheres. Venture capitalists can discover promising new technologies and talent, professors can explore avenues for research funding and real-world application of their work, and software engineers can gain insights from both investors and academics to drive innovation.
...
**** EVENT INFORMATION ****
SERIES_A: npc_1, npc_2
event_1: 
story: Ava, seizing an opportunity to solidify her control and subtly undermine Soren's autonomy, proposes a collaborative research project. This project would combine Soren's reinforcement learning algorithms with Lexicon Venture's proprietary natural language processing technology, ostensibly to enhance patient-doctor communication and improve diagnostic accuracy. Soren, wary of Ava's motives but enticed by the potential for advancement, reluctantly agrees. However, he soon discovers Ava has been using the project to harvest sensitive patient data for undisclosed purposes, rekindling his ethical concerns and distrust.
info: An encrypted hard drive containing anonymized patient records is discovered hidden in a research lab.
question: Ava Armitage is working on a project involving breaking down words into their root forms using NLP techniques. Speak with her about what specific NLP technique she is using to achieve this and then determine what this technique reduces words to.
answer: Stemming

event_2: 
story: Ava, leveraging her political connections, arranges a meeting with a prominent senator interested in implementing Soren's AI diagnostic tools in a nationwide healthcare initiative. Soren is initially excited about the potential impact, envisioning his work helping millions. However, during the meeting, the senator reveals plans to use the technology for profiling and surveillance, targeting individuals with pre-existing conditions and limiting their access to resources.  Soren, horrified, vehemently objects, creating a public rift with Ava and the senator. His ethical stance puts him at odds with powerful figures, jeopardizing his career and reputation.
info: A draft bill outlining a new healthcare initiative with controversial data-sharing provisions is leaked to the press.
question: Ava is working on a project involving sentiment analysis of public opinion on the new healthcare initiative. Speak with her to learn about sentiment analysis and what numerical label she would assign to a piece of text that expresses neither positive nor negative sentiment.
answer: 0

event_3: 
story: Ava, enraged by Soren's defiance and the potential financial fallout, threatens to expose his past unethical research practices involving human trials. She holds this information over him like a sword, demanding he publicly endorse the healthcare initiative and retract his objections. Soren, trapped and facing professional ruin, contemplates exposing Ava's data harvesting practices in retaliation. This creates a volatile impasse, with both parties holding potentially devastating secrets and a growing desperation that could easily escalate to violence.
info: An anonymous email containing research protocols for an unapproved clinical trial is sent to a medical ethics board.
question: Ava is utilizing a specific type of model for tagging different parts of speech in text data. Talk to her to learn about this model and find out what type of model she is using for part-of-speech tagging.
answer: Hidden Markov Model


SERIES_B: npc_1, npc_3
event_1: 
story: Ava, impressed by Kai's talent and recognizing his potential value, offers him a leadership role in a new division within Omniscient Technologies focusing on “emotion recognition AI” for marketing and advertising purposes. Kai, initially hesitant due to the ethical implications, is persuaded by Ava's promises of responsible development and the opportunity to influence the technology's direction. However, he soon discovers the technology is being used to manipulate consumer behavior through subliminal messaging and targeted emotional triggers, contradicting Ava's assurances and fueling his growing suspicion.
info: A discarded marketing survey asks unusually probing questions about emotional responses to everyday stimuli.
question: Soren Sepulveda has been exploring various machine learning paradigms. Discuss with him to understand how Reinforcement Learning differs from other types like supervised and unsupervised learning and determine what category Reinforcement Learning generally falls under.
answer: Evaluative

event_2: 
story: Ava tasks Kai with developing facial recognition software for a lucrative government contract.  She assures him it's for enhancing public safety, but Kai discovers its true purpose is to monitor and suppress political dissent. Feeling used and betrayed, Kai secretly modifies the software to include subtle flaws, hindering its effectiveness and protecting the privacy of innocent citizens. This act of defiance risks his career and exposes him to potential retaliation from Ava.
info: A seemingly innocuous error in facial recognition software consistently misidentifies individuals with specific political affiliations.
question: Soren Sepulveda is engrossed in a particular algorithm for Reinforcement Learning. Ask Soren about this algorithm and try to find out what the "Q' in the name of that algorithm stands for.
answer: Quality

event_3: 
story: Ava, suspecting sabotage, launches an investigation into the facial recognition software's flaws. Evidence leads back to Kai, and Ava confronts him, threatening legal action and professional blacklisting. Kai, cornered and disillusioned, decides to expose Ava's corrupt practices and her manipulation of both him and the government. He threatens to release evidence of her deceit, sparking a dangerous power struggle with potentially fatal consequences.
info: An encrypted file containing metadata from altered facial recognition software is found hidden within a seemingly unrelated project folder.
...
event_1: 
story: Kai confides in Soren about his ethical concerns regarding the emotion recognition AI project at Omniscient. He seeks guidance from his mentor, hoping Soren will support his stance against Ava's manipulative tactics. However, Soren, blinded by his own ambitions and dependence on Ava's funding, dismisses Kai's concerns as naive and advises him to prioritize career advancement over ethical idealism. This leaves Kai feeling disillusioned and isolated, questioning Soren's integrity and the foundation of their mentor-mentee relationship.
info: A crumpled napkin with scribbled calculations on reinforcement learning algorithms is found in the trash.
question: Kai Zhang has been researching various edge detection techniques. Talk to him about the criteria used to evaluate edge detectors and figure out the name of the algorithm that is considered the optimal edge detector based on these criteria.
answer: Canny edge detection

event_2: 
story: Kai discovers Soren is consulting for the very government surveillance program Kai has been trying to undermine. Feeling betrayed and disgusted by his mentor's hypocrisy, Kai confronts Soren, accusing him of prioritizing personal gain over his supposed ethical principles. Soren, defensive and ashamed, attempts to justify his actions, claiming it's the only way to secure funding for his research and ultimately save lives. This confrontation deepens the rift between them, leaving Kai wrestling with feelings of anger, disappointment, and a growing desire for justice.
info: An encrypted email containing facial recognition data is intercepted, originating from a Stanford University server.
question: Kai Zhang is analyzing images from a surveillance system.  He is using vanishing points to understand the perspective of the camera.  Ask him how many vanishing points are present in these images and then determine how many more vanishing points there are than the minimum possible.
answer: 1

event_3: 
story: Kai uncovers evidence directly linking Soren's research to the persecution and harm of innocent people in his home country. This revelation shatters any remaining respect or empathy Kai held for his former mentor. Driven by a thirst for justice and a need to prevent further suffering, Kai resolves to expose Soren's complicity and hold him accountable for his actions. This sets the stage for a final, potentially deadly confrontation, as Kai grapples with the decision of whether to seek revenge or pursue a path of justice that could also destroy Soren's life and legacy.
info: A hidden folder on Soren's computer reveals medical records from a clinic in Kai's home country.
question: Kai Zhang is designing a deep learning model for facial recognition.  He is currently focused on reducing the size of the data as it passes through the network. Ask him what operation he is using to accomplish this and what specific type he has chosen.
answer: Pooling
...
answer: Pooling"""}
    ...
    chat_prompt = f"""Use the context to answer the question.
    context:
    {context[self.name]}
    ...
    response = self.model.generate_content(char_prompt).text
    return response, {}
